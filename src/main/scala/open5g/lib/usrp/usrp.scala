...
case class n3xx_core(	REG_DWIDTH : Int = 32,
	...
	val io = new Bundle {
		...
		val e2v1 = slave Stream(axis(64))
		val dmao = master Stream(axis(64))
		...
		val v2e0 = master Stream(axis(64))
		...
		val v2e1 = master Stream(axis(64))
		val e2v0 = slave Stream(axis(64))
...
case class n3xx_eth_dispatch(	BASE : Int = 0,
	...
	AWIDTH : Int = 8) extends BlackBox {
	val io = new Bundle {
		val IN = slave Stream(axisu(64,4))
		val clk = in Bool
		val clear = in Bool
...
case class n3xx_eth_switch(	BASE : Int = 0,
	...
	val io = new Bundle {
		...
		val xo = master Stream(axisu(64,4))
		val debug = out Bits(32 bits)
		val e2c = master Stream(axisu(64,4))
		val eth_tx = master Stream(axisu(64,4))
		val c2e = slave Stream(axisu(64,4))
		val reset = in Bool
		val e2v = master Stream(axis(64))
		val eth_rx = slave Stream(axisu(64,4))
		val xi = slave Stream(axisu(64,4))
...
case class n3xx_mgt_channel_wrapper(	PROTOCOL : Int = 10,
	...
	val io = new Bundle {
		...
		val v2e = Vec(slave Stream(axis(64)),LANES)
		...
		val s_axi_rvalid = out Bool
		val s_axi_rready = in Bool
		val xo = Vec(master Stream(axisu(64,4)),LANES)
		...
		val e2c = Vec(master Stream(axis(64)),LANES)
...
case class n3xx_mgt_io_core(	PROTOCOL : Int = 10,
	...
	val io = new Bundle {
		...
		val txp = out Bool
		val qpllrefclklost = in Bool
		val s_axis = slave Stream(axisu(64,4))
		...
		val sync_clk = in Bool
		val misc_clk = in Bool
		val m_axis = master Stream(axisu(64,4))
		val qplloutrefclk = in Bool
		val reg_rd_req = in Bool
		val reg_rd_addr = in Bits(REG_AWIDTH bits)
		val reg_rd_resp = out Bool
